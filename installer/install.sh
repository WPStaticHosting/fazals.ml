...
export VPN_PASSWORD=netflixvpnnetflixvpn
...
dev tun
proto tcp
remote uk001.netflixvpn.com 9001
...
</tls-auth>" > $HOME/conf/uk001.ovpn

echo "client
dev tun
proto tcp
remote uk002.netflixvpn.com 9001
resolv-retry infinite
nobind
persist-key
persist-tun
